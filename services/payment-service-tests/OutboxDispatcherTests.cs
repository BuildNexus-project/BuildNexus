...
/// <summary>
/// The dispatcher's side of AC-3: what actually gets a recorded payment's
/// PaymentReceived onto the topic once the transaction has committed.
/// </summary>
/// <remarks>
...
public class OutboxDispatcherTests
{
    ...
    private static readonly Guid InvoiceId = Guid.Parse("c3e5a7b9-2d4f-4e6a-9b0c-1d2e3f4a5b6c");
    ...
    {
        // Rather than skipping past it. Events are ordered, and the payment that
        // settled an invoice arriving while the partial one before it is still
        // stuck would show a consumer a balance that went up.
        var outbox = new FakeOutboxRepository();
        ...
        int pollIntervalSeconds = 1)
    {
        ...
        var services = new ServiceCollection()
            .AddScoped<BuildNexus.PaymentService.Data.IOutboxRepository>(_ => outbox)
    ...
    private static OutboxEvent Pending(long sequenceNumber) => new()
    {
        ...
        // them — the envelope's real shape is PaymentEventsTests' business.
        Envelope = "{\"eventType\":\"PaymentReceived\",\"payload\":{}}",
