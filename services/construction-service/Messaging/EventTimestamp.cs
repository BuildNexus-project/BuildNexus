...
{
    /// <summary>Stamps the value as UTC before it becomes a <see cref="DateTimeOffset"/>.</summary>
    /// <remarks>
    ...
    /// have <see cref="DateTimeOffset"/> apply the <em>server's local</em> offset,
    /// and the event would claim a time that never happened on any machine not
    /// set to UTC. Relabelling is correct here rather than merely convenient,
    /// precisely because the value already is UTC.
    /// </remarks>
