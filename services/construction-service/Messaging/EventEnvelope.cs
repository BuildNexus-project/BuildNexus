...
/// service has read since US-23. The same shape the Project and Design Services
/// serialise — one envelope across all four publishing services, so a consumer
/// can read the type and decide whether it cares before it looks at the payload
/// at all.
/// <para>
...
public sealed class EventEnvelope<TPayload>
{
    ...
    /// <summary>What happened — for example <c>ConstructionStarted</c>.</summary>
