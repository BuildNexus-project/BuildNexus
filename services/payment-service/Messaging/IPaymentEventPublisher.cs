...
/// </summary>
/// <remarks>
/// Takes an <see cref="OutboxEvent"/> rather than a payment, because by the time
/// anything publishes, the event has already been decided and written down:
/// <see cref="PaymentEvents"/> minted the envelope inside the transaction that
/// recorded the payment. This side only carries the bytes across.
/// <para>
