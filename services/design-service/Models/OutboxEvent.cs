...
/// mapped by hand from the <c>design_outbox_events</c> table.
/// </summary>
/// <remarks>
...
/// commit together or not at all, so there is no window in which a version was
/// approved and nobody was told. Getting it onto Kafka afterwards is the
/// dispatcher's job, and a broker that is down delays that rather than losing it.
/// <para>
...
public class OutboxEvent
{
    ...
    /// <summary>
    /// The document the event is about, and the Kafka message key — every event
    /// about one document lands on the same partition and so reaches consumers
    /// in the order it happened.
    /// </summary>
    public Guid DocumentId { get; set; }

    /// <summary>One of <see cref="Messaging.DesignEventTypes"/>.</summary>
